<script lang="ts">
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      error = "Une erreur s'est produite lors de l'enregistrement du client. Veuillez réessayer.";
    } finally {
      submitting = false;
    }
  }
  ...
  {:else}
    <form class="p-6" on:submit|preventDefault={handleSubmit}>
      ...
      <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
        ...
        <div>
          <label for="company_name" class="label">Entreprise <span class="text-red-500">*</span></label>
          <input
            type="text"
            id="company_name"
            class="input"
        ...
        <div>
          <label for="business_category" class="label">Type d'offre <span class="text-red-500">*</span></label>
          <select
        ...
        <div>
          <label for="estimated_monthly_revenue" class="label">Revenu mensuel estimé (€)</label>
          <input
            type="number"
