...
<svelte:head>
  <title>Ajouter un nouveau prospect | CRM Platform</title>
</svelte:head>
        ...
        <div class="flex">
          ...
          <div class="ml-3">
            <p class="text-sm font-medium text-green-800 dark:text-green-200">
              🎉Prospect ajouté avec succès!🎉 Redirection...
            </p>
          </div>
        </div>
      </div>
  ...
  {:else}
    <form class="p-6" on:submit|preventDefault={handleSubmit}>
      ...
      <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
        ...
        <div>
          <label for="contact_phone" class="label">Téléphone</label>
          <input
            type="tel"
            id="contact_phone"
            class="input"
        ...
        <div>
          <label for="interest_level" class="label"
            >Niveau d'intérêt <span class="text-red-500">*</span></label
          >
          <select
            id="interest_level"
            class="input"
        ...
        <div>
          <label for="next_follow_up_date" class="label"
            >Date de relance <span class="text-red-500">*</span></label
          >
          <input
            type="date"
